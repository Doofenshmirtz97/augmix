...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./resnet18', help='Folder to save checkpoints.')
parser.add_argument('--load', '-l', type=str, default='/home/g050878/augmix/resnet18/sgdnpt', help='Checkpoint path to resume / test.')
...
parser.add_argument(
    ...
    '-r',
    type=str,
    default='/home/g050878/augmix/resnet18/sgdnpt',
...
c_p_dir = '/home/g050878/augmix/data/cifar/' + c_p_dir
